        ...
        <DropdownMenu.Root>
            ...
            <DropdownMenu.Portal>
                <DropdownMenu.Content
                    ...
                    sideOffset={5}
                >
                    <DropdownMenu.Item className="group leading-none rounded-[3px] flex items-center py-4 px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none">
                        Logout
                    </DropdownMenu.Item>
                </DropdownMenu.Content>
            </DropdownMenu.Portal>
