...
export const DropdownMenu2 = ({
    ...
    return (
        <Root>
            ...
            <Portal>
                <Content
                    className="font-poppins min-w-[200px] bg-white rounded border border-[#CCC] shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade [&>*:nth-child(even)]:border-y [&>*:nth-child(even):border-y-neutral-300 dropdown-scroll"
                    sideOffset={5}
                >
                    {options?.map((option: any) =>
