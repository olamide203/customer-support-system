        ...
        <>
            ...
            <div className="mt-[70px] bg-neutral-200 pt-[30px] px-[15vw]">
                <div className='flex justify-between'>
                    ...
                    <span className="text-sm text-blue-400 italic underline font-poppins">Goto Dashboard</span>
                </div>
                <div>
                ...
                <div className='flex gap-4 font-poppins items-center justify-end'>
                    ...
                    <div className='flex gap-2 items-center'>
                        ...
                        <span>From</span>
                        <input className='border-[1px] p-2 rounded-[5px] border-neutral-400 bg-transparent' type='date'/>
                        <span>To</span>
                        <input className='border-[1px] p-2 rounded-[5px] border-neutral-400 bg-transparent' type='date'/>
                    </div>
                </div>
